...
const About = () => {
  useEffect(() => {
    applySeo({
      title: "About Skyexchlogin | India's Trusted Online Sports Gaming Platform 2026",
      description:
        "About Skyexchlogin (Sky Exchange Login) — India's leading online sports gaming platform since 2017. 10L+ players, 1000+ games, instant ₹ withdrawals, 24x7 WhatsApp support.",
      canonical: "https://skyexchlogin.live/about",
      keywords:
        "about skyexchlogin, sky exchange login, online sports gaming platform, sports betting platform online, skyexchlogin online platform",
      jsonLd: [
        {
          "@context": "https://schema.org",
          "@type": "AboutPage",
          name: "About Skyexchlogin",
          url: "https://skyexchlogin.live/about",
          description:
            "Learn about Skyexchlogin — India's trusted online cricket and casino gaming platform.",
        },
        {
          "@context": "https://schema.org",
          "@type": "BreadcrumbList",
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "About", item: "https://skyexchlogin.live/about" },
          ],
        },
      ],
    });
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="container py-12 md:py-20">
        ...
        <div className="max-w-3xl mb-12">
          <div className="text-xs font-semibold tracking-widest text-primary uppercase mb-3">About Skyexchlogin</div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-5">
            India's most trusted <span className="text-gradient-gold">online sports gaming platform</span>
          </h1>
          <p className="text-muted-foreground text-base md:text-lg">
            Skyexchlogin (Sky Exchange Login) has been India's leading online cricket & casino platform since 2017.
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start mb-16">
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Skyexchlogin was founded in 2017 with one mission — make online sports gaming in India simple, safe and lightning fast. No long signup forms, no email verification delays, no hidden fees.
            </p>
            <p className="text-muted-foreground mb-4">
              Today, Skyexchlogin serves over 10 lakh active players across India, processing more than ₹500 crore in payouts. We power live cricket betting on IPL, T20 World Cup, ODI and Test cricket — plus 1000+ casino games including Andar Bahar, Teen Patti, Aviator and live dealer roulette.
            </p>
            <p className="text-muted-foreground">
              Every Skyexchlogin account is created on WhatsApp, secured with bank-grade SSL, and supported 24x7 by real humans — not chatbots.
            </p>
          </div>
        ...
        <div className="p-6 md:p-10 rounded-2xl border border-primary/30 bg-gradient-card text-center shadow-gold">
          ...
          <p className="text-sm md:text-base text-muted-foreground mb-6">
            Get your free Skyexchlogin ID on WhatsApp in under 60 seconds.
          </p>
