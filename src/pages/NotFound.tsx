...
const NotFound = () => {
  ...
  useEffect(() => {
    ...
    applySeo({
      title: "Page Not Found | Skyexchid",
      description:
        "The page you're looking for doesn't exist on Skyexchid. Return home to get your online cricket & casino ID on WhatsApp.",
      canonical: `https://skyexchid.live${location.pathname}`,
    });
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background">
      <div className="text-center px-6">
        ...
        <p className="mb-6 text-xl text-muted-foreground">Oops! This page doesn't exist on Skyexchid.</p>
