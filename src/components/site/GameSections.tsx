...
const Card = ({ g }: { g: Game }) => (
  ...
  >
    <div className="aspect-square overflow-hidden">
      <img src={g.img} alt={`${g.title} - bet on ${g.title} live online at skyexchlogin.live`} loading="lazy" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
    </div>
    {g.tag && (
